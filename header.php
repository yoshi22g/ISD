...
<div id="page" class="hfeed site <?php echo get_theme_mod( 'layout_setting', 'no-sidebar' ); ?>">
	...
	<?php
		...
		<?php if ($dir == 'research'): ?>
			...
			<div class="research-caption min">
				<img id="link-arrow" class="closed" src="<?php echo get_stylesheet_directory_uri() ?>/images/chevron_right_black.svg">
				<h3 class="research-caption-title"> Research Title </h3>
				<p class="research-caption-text hidden">Research caption</p>
				<a href="" class="research-caption-link hidden">research link</a>
			</div>
		<?php endif; ?>
